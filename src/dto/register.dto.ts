...
//   })
//   category: NewsCategory = NewsCategory.NPB; // Default to NPB

//   @IsNotEmpty({ message: '見出しを設定してください' })
//   @IsString({ message: '見出しは文字列である必要があります' })
//   @Length(30, 38, { message: '見出しは30文字以上38文字以内で設定してください' })
//   header: string;
